...
# 4. Regras de negócio
- **RN01 – Cadastro de Usuário:** Para acessar o sistema, o usuário deve realizar um cadastro com e-mail único e senha válida.
- **RN02 – Edição de Perfil:** O usuário poderá editar apenas seus próprios dados, como nome, foto e senha.
- **RN03 – Criação de Tarefas:** Para organizar os estudos, o usuário deve criar tarefas com título e prazo definidos.
- **RN04 – Organização em Kanban:** Toda tarefa criada deve iniciar como “A fazer” e só pode estar em um status por vez (A fazer, Em andamento ou Concluído).
- **RN05 – Conclusão de Tarefas:** Para marcar uma tarefa como concluída, ela deve ter sido previamente criada e estar em andamento ou pendente.
- **RN06 – Definição de Metas Diárias:** O usuário deve definir metas diárias de estudo (quantidade de exercícios ou tempo).
- **RN07 – Cumprimento de Metas:** A meta diária só será considerada concluídas quando todas as tarefas diárias forem feitas.
- **RN08 – Atribuição de Pontos (XP):** O usuário receberá pontos ao concluir tarefas ou metas diárias.
- **RN09 – Controle de Ranking:** O ranking será baseado na quantidade total de pontos acumulados pelos usuários.
- **RN10 – Atualização de Ranking:** A posição no ranking deve ser atualizada sempre que o usuário ganha novos pontos.
- **RN11 – Geração de Plano de Estudo com IA:** A IA deve gerar planos de estudo com base nas informações e desempenho do usuário.
- **RN12 – Geração de Exercícios com IA:** A IA deve gerar exercícios personalizados conforme o nível e tema definidos pelo usuário.
- **RN13 – Explicação com IA:** A IA deve fornecer explicações claras e detalhadas mediante solicitação do usuário.
- **RN14 – Registro de Progresso:** O sistema deve registrar as tarefas concluídas e metas atingidas pelo usuário.
